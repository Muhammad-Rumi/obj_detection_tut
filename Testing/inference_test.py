...
def NMs(boxes, confidences):
      ...
      while len(score) > 0:
         ...
         if confidences[current_index] > SCORE_THRESHOLD:
        ...
        #iou
         ...
         np.append(remaining_indices, current_index)
         score = scores[remaining_indices]
      
         print("scores:", score)
      # print('boundin boxex', len(indices))
...
def post_process(input_image, outputs):
      ...
      # assert 0, f"{input_image.shape[:2]}"
      # Resizing factor.
      x_factor = image_width / INPUT_WIDTH
      y_factor =  image_height / INPUT_HEIGHT
      # assert 0, f'xfactor.shape: {x_factor.shape}'
